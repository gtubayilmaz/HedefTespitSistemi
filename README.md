...
STM32 tarafının donanım şeması [proje/devre_sema.jpeg](proje/devre_sema.jpeg) içinde yer alır.
...
| [proje/](proje/) | STM32 projesinin kapsayıcı klasörü. |
| [proje/README.md](proje/README.md) | STM32 projesinin kurulum, bağlantı ve kullanım rehberi. |
| [proje/kod/Core/Src/main.c](proje/kod/Core/Src/main.c) | STM32 uygulamasının ana kodu. |
| [proje/kod/HedefTespitSistemi.ioc](proje/kod/HedefTespitSistemi.ioc) | STM32CubeMX proje yapılandırması. |
| [proje/devre_sema.jpeg](proje/devre_sema.jpeg) | STM32 tarafı için bağlantı şeması. |
...
Detaylı kurulum ve çalışma adımları için [proje/README.md](proje/README.md) dosyasına bakın. Projeyi açmak için [proje/kod/HedefTespitSistemi.ioc](proje/kod/HedefTespitSistemi.ioc) dosyasını STM32CubeIDE içinde kullanın. Donanım bağlantı detayı için [proje/devre_sema.jpeg](proje/devre_sema.jpeg) dosyasına bakabilirsiniz.
